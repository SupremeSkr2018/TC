          ...
          <div class="level">
            <div v-for="(item, index) in selectedWorkerList" :key="item.code">
              <div
                ...
                @click="selectWorker(item.code,index)"
...
export default {
  ...
  methods: {
    ...
    checkPostLocalData() {
      let that = this;
      localforage
        .getItem("local10" + that.baseURL + that.userCode)
        .then(function(value) {
          ...
          res => {
            ...
            if (res && res.status == 200) {
              ...
              if (num == len) {
                ...
                localforage
                  .removeItem("local10" + that.baseURL + that.userCode)
                  .then(function() {})
                  .catch(function() {});
                that.localData = null;
              }
          ...
          localforage
            ...
            .then(function(value) {
              ...
              if (!res) {
                ...
                localforage
                  .setItem(
                    "local10" + that.baseURL + that.userCode,
                    JSON.stringify(arr)
                  )
                  .then(function() {
                    // 当值被存储后，可执行其他操作
    ...
    selectWorker: function(code, index) {
...
.worker .btn.workerbtn div:first-of-type {
  font-size: 30px;
}
.step2 li {
