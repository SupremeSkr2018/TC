...
export default {
  ...
  methods: {
    ...
    checkPostLocalData() {
      let that = this;
      localforage
        .getItem("local3" + that.baseURL + that.userCode)
        .then(function(value) {
          ...
          res => {
            ...
            if (res && res.status == 200) {
              ...
              if (num == len) {
                ...
                localforage
                  .removeItem("local3" + that.baseURL + that.userCode)
                  .then(function() {})
                  .catch(function() {});
                that.localData = null;
              }
          ...
          localforage
            ...
            .then(function(value) {
              ...
              if (!res) {
                ...
                localforage
                  .setItem(
                    "local3" + that.baseURL + that.userCode,
                    JSON.stringify(arr)
                  )
                  .then(function() {
                    // 当值被存储后，可执行其他操作
    ...
    baseUrl:function(){
      ...
      var url = "<%=climbingKilnWhiteIn%>stockRecord/selectStockRecord?data=" + dat;
